      ...
      <table class="min-w-full table-auto border-collapse border border-gray-300">
        ...
        <tbody  class="bg-gray-200">
              ...
              if(!$result){
                ...
                <td class="border border-gray-300 px-4 py-2"><a href="update.php"><button data-id="<?php $row['author_id'] ?>" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600">Update</button></a></td>
